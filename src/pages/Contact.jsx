  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        {/* Address Section */}
        <div className="mb-12">
          <div className="bg-white border border-amber-500/30 rounded-xl p-6 lg:p-8 hover:bg-amber-50/50 hover:border-amber-500/50 transition-all duration-300 shadow-md">
            <div className="flex items-start gap-4">
              <div className="bg-amber-500/10 p-3 rounded-full flex-shrink-0">
                <FiMapPin className="text-amber-600 text-2xl" />
              </div>
              <div className="flex-1">
                <h2 className="text-2xl lg:text-3xl font-semibold text-amber-600 mb-4">
                  Address
                </h2>
                <div className="text-slate-800 text-lg lg:text-xl leading-relaxed">
                  <p className="font-semibold mb-2">Aniyil Sreekrishna Swami Temple</p>
                  <p>Edavanakkad, Vypin</p>
                  <p>Ernakulam, Kerala</p>
                  <p className="text-amber-600 font-medium">682502</p>
                </div>
                <a
                  ...
                  className="inline-block mt-4 text-amber-600 hover:text-amber-700 transition-colors duration-200 underline underline-offset-2"
                >
                  View on Google Maps
                </a>
              </div>
        ...
        <div className="mb-12">
          <div className="bg-white border border-amber-500/30 rounded-xl p-6 lg:p-8 hover:bg-amber-50/50 hover:border-amber-500/50 transition-all duration-300 shadow-md">
            <h2 className="text-2xl lg:text-3xl font-semibold text-amber-600 mb-6">
              Management
            </h2>
            <div className="space-y-4">
              <div className="border-l-4 border-amber-500/50 pl-4">
                <p className="text-slate-600 text-sm uppercase tracking-wide mb-1">
                  Cochin Devaswom Board Officer
                </p>
                <p className="text-slate-800 text-lg font-medium">A.R. Rajeev</p>
              </div>
              <div className="border-l-4 border-amber-500/50 pl-4 mt-6">
                ...
                <p className="text-slate-500 text-sm">REG NO: KUS723/2022</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-12">
          <div className="bg-white border border-amber-500/30 rounded-xl p-6 lg:p-8 hover:bg-amber-50/50 hover:border-amber-500/50 transition-all duration-300 shadow-md">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div className="flex-1">
                <h2 className="text-2xl lg:text-3xl font-semibold text-amber-600 mb-2">
                  Donations
                </h2>
            ...
            <div className="bg-amber-50/30 border-2 border-amber-500/30 rounded-lg p-6 lg:p-8 space-y-4">
              <div>
                <p className="text-slate-500 text-sm uppercase tracking-wide mb-1">
                  Account Name
                </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-slate-800 text-xl font-semibold text-amber-600">
                    0024050000000511
                  </p>
                </div>
                <div>
