        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
          ...
          <div className="flex-1">
            <p className="text-slate-800 text-lg lg:text-xl leading-relaxed font-malayalam">
              ...
              കൃഷ്ണവേഷം ആടിയ അജ്ഞാതൻ പെട്ടെന്ന് അദൃശ്യമായി. പിന്നീട് പ്രശ്നം വെച്ചപ്പോൾ
              ...
              ചെയ്തു. 'അണിയറ കൃഷ്ണനിൽ' നിന്നാണത്രെ അണിയിൽ ക്ഷേത്രം ഉണ്ടായത്. ആ
              സ്മരണയിൽ അടുത്ത കാലത്ത് കഥകളി നടത്തി വരുന്നു.
            </p>
          </div>
