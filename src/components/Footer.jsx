        ...
        <div className="container mx-auto px-6 py-8 md:py-10">
          {!isHomePage && (
            <div className="flex flex-col md:flex-row justify-between items-center gap-6 md:gap-8">
              {/* Location */}
              <div className="flex items-center text-slate-700 text-sm md:text-base">
          ...
          {/* Bottom Bar */}
          <div className={`border-t border-amber-500/20 ${!isHomePage ? "mt-6" : "mt-0"} pt-6`}>
            <div className="flex flex-col md:flex-row justify-between items-center gap-3 text-sm text-slate-600">
